...
#include "BP_Dumpster_structs.hpp"
...
class ABP_Dumpster_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Dumpster.BP_Dumpster_C"));
		return ptr;
	}
