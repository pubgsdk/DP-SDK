...
#include "BTS_CanPath_structs.hpp"
...
public:
	...
	class UBP_SmartAIComponent_C*                      Smart_AI;                                                 // 0x00A8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BTS_CanPath.BTS_CanPath_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BTS_CanPath(int EntryPoint);
};
