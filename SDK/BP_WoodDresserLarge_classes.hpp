...
#include "BP_WoodDresserLarge_structs.hpp"
...
// BlueprintGeneratedClass BP_WoodDresserLarge.BP_WoodDresserLarge_C
// 0x0030 (0x0318 - 0x02E8)
class ABP_WoodDresserLarge_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodDresserLarge.BP_WoodDresserLarge_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WoodDresserLarge(int EntryPoint);
};
