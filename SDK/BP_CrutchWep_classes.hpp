...
#include "BP_CrutchWep_structs.hpp"
...
// BlueprintGeneratedClass BP_CrutchWep.BP_CrutchWep_C
// 0x006C (0x0768 - 0x06FC)
class ABP_CrutchWep_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CrutchWep.BP_CrutchWep_C"));
		return ptr;
	}
