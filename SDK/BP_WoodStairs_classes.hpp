...
#include "BP_WoodStairs_structs.hpp"
...
// BlueprintGeneratedClass BP_WoodStairs.BP_WoodStairs_C
// 0x0020 (0x02F8 - 0x02D8)
class ABP_WoodStairs_C : public ABP_MasterDecoPart_C
{
public:
	...
	class UBP_GridComponent_C*                         BP_GridComponent;                                         // 0x02E0(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodStairs.BP_WoodStairs_C"));
		return ptr;
	}
