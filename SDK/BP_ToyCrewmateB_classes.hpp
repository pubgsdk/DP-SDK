...
#include "BP_ToyCrewmateB_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCrewmateB.BP_ToyCrewmateB_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ToyCrewmateB_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCrewmateB.BP_ToyCrewmateB_C"));
		return ptr;
	}
