...
#include "BP_CrateRed_structs.hpp"
...
// BlueprintGeneratedClass BP_CrateRed.BP_CrateRed_C
// 0x0030 (0x0318 - 0x02E8)
class ABP_CrateRed_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CrateRed.BP_CrateRed_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CrateRed(int EntryPoint);
};
