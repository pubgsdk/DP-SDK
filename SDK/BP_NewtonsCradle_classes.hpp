...
#include "BP_NewtonsCradle_structs.hpp"
...
// BlueprintGeneratedClass BP_NewtonsCradle.BP_NewtonsCradle_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_NewtonsCradle_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_NewtonsCradle.BP_NewtonsCradle_C"));
		return ptr;
	}
