...
#include "BP_SignFaceMaskRequired_structs.hpp"
...
// BlueprintGeneratedClass BP_SignFaceMaskRequired.BP_SignFaceMaskRequired_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignFaceMaskRequired_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignFaceMaskRequired.BP_SignFaceMaskRequired_C"));
		return ptr;
	}
