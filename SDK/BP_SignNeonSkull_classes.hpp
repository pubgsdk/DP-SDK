...
#include "BP_SignNeonSkull_structs.hpp"
...
// BlueprintGeneratedClass BP_SignNeonSkull.BP_SignNeonSkull_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignNeonSkull_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignNeonSkull.BP_SignNeonSkull_C"));
		return ptr;
	}
