...
#include "BP_ToyPlushStitch_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushStitch.BP_ToyPlushStitch_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushStitch_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushStitch.BP_ToyPlushStitch_C"));
		return ptr;
	}
