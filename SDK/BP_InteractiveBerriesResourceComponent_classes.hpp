...
#include "BP_InteractiveBerriesResourceComponent_structs.hpp"
...
// BlueprintGeneratedClass BP_InteractiveBerriesResourceComponent.BP_InteractiveBerriesResourceComponent_C
// 0x000F (0x06B8 - 0x06A9)
class UBP_InteractiveBerriesResourceComponent_C : public UBP_MasterResourceComponent_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_InteractiveBerriesResourceComponent.BP_InteractiveBerriesResourceComponent_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_InteractiveBerriesResourceComponent(int EntryPoint);
};
