...
#include "BP_ToyCrewmateO_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCrewmateO.BP_ToyCrewmateO_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ToyCrewmateO_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCrewmateO.BP_ToyCrewmateO_C"));
		return ptr;
	}
