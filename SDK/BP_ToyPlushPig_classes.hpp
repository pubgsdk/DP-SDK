...
#include "BP_ToyPlushPig_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushPig.BP_ToyPlushPig_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushPig_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushPig.BP_ToyPlushPig_C"));
		return ptr;
	}
