...
#include "BP_MetalToolChest_structs.hpp"
...
// BlueprintGeneratedClass BP_MetalToolChest.BP_MetalToolChest_C
// 0x0030 (0x0318 - 0x02E8)
class ABP_MetalToolChest_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MetalToolChest.BP_MetalToolChest_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MetalToolChest(int EntryPoint);
};
