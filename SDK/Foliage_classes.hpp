...
public:
	...
	struct FMulticastScriptDelegate                    OnInstanceTakeRadialDamage;                               // 0x0678(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPublic)
