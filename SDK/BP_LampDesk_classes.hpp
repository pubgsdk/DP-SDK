...
#include "BP_LampDesk_structs.hpp"
...
class ABP_LampDesk_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_LampDesk.BP_LampDesk_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_LampDesk(int EntryPoint);
};
