...
#include "BP_WindowBarricadeMetal_structs.hpp"
...
// BlueprintGeneratedClass BP_WindowBarricadeMetal.BP_WindowBarricadeMetal_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_WindowBarricadeMetal_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WindowBarricadeMetal.BP_WindowBarricadeMetal_C"));
		return ptr;
	}
