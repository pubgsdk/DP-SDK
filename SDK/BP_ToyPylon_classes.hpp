...
#include "BP_ToyPylon_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPylon.BP_ToyPylon_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPylon_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPylon.BP_ToyPylon_C"));
		return ptr;
	}
