...
#include "BP_TombstoneBanshee_structs.hpp"
...
// BlueprintGeneratedClass BP_TombstoneBanshee.BP_TombstoneBanshee_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_TombstoneBanshee_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TombstoneBanshee.BP_TombstoneBanshee_C"));
		return ptr;
	}
