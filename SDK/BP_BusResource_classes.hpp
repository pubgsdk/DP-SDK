...
#include "BP_BusResource_structs.hpp"
...
// BlueprintGeneratedClass BP_BusResource.BP_BusResource_C
// 0x0026 (0x02D8 - 0x02B2)
class ABP_BusResource_C : public ABP_MasterResource_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_BusResource.BP_BusResource_C"));
		return ptr;
	}
	...
	void HideResource();
	void ChangeMaterial();
	void ExecuteUbergraph_BP_BusResource(int EntryPoint);
};
