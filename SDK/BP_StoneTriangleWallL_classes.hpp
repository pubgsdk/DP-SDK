...
#include "BP_StoneTriangleWallL_structs.hpp"
...
class ABP_StoneTriangleWallL_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StoneTriangleWallL.BP_StoneTriangleWallL_C"));
		return ptr;
	}
