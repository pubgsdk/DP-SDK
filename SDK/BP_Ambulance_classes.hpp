...
#include "BP_Ambulance_structs.hpp"
...
class ABP_Ambulance_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Ambulance.BP_Ambulance_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Ambulance(int EntryPoint);
};
