...
#include "BP_MasterCraftingBuildPart_structs.hpp"
...
public:
	...
	class UBP_CraftingComponent_C*                     BP_CraftingComponent;                                     // 0x02E0(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MasterCraftingBuildPart(int EntryPoint);
};
