...
#include "BP_GronkhsTrophy_structs.hpp"
...
// BlueprintGeneratedClass BP_GronkhsTrophy.BP_GronkhsTrophy_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_GronkhsTrophy_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_GronkhsTrophy.BP_GronkhsTrophy_C"));
		return ptr;
	}
