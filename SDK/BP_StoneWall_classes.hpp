...
#include "BP_StoneWall_structs.hpp"
...
class ABP_StoneWall_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StoneWall.BP_StoneWall_C"));
		return ptr;
	}
