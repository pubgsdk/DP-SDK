...
#include "BP_MetalTriangleWallL_structs.hpp"
...
class ABP_MetalTriangleWallL_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MetalTriangleWallL.BP_MetalTriangleWallL_C"));
		return ptr;
	}
