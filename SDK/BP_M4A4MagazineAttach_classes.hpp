...
#include "BP_M4A4MagazineAttach_structs.hpp"
...
class ABP_M4A4MagazineAttach_C : public ABP_MasterAttachment_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_M4A4MagazineAttach.BP_M4A4MagazineAttach_C"));
		return ptr;
	}
