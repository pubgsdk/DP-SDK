...
#include "BP_ToyOrbiter_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyOrbiter.BP_ToyOrbiter_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyOrbiter_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyOrbiter.BP_ToyOrbiter_C"));
		return ptr;
	}
