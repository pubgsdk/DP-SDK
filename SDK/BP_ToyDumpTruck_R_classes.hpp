...
#include "BP_ToyDumpTruck_R_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyDumpTruck_R.BP_ToyDumpTruck_R_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyDumpTruck_R_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyDumpTruck_R.BP_ToyDumpTruck_R_C"));
		return ptr;
	}
