...
#include "BP_WindowGlassCover_structs.hpp"
...
// BlueprintGeneratedClass BP_WindowGlassCover.BP_WindowGlassCover_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_WindowGlassCover_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WindowGlassCover.BP_WindowGlassCover_C"));
		return ptr;
	}
