...
#include "BP_ToyJelloStapler_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyJelloStapler.BP_ToyJelloStapler_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyJelloStapler_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyJelloStapler.BP_ToyJelloStapler_C"));
		return ptr;
	}
