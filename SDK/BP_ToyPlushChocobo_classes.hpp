...
#include "BP_ToyPlushChocobo_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushChocobo.BP_ToyPlushChocobo_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushChocobo_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushChocobo.BP_ToyPlushChocobo_C"));
		return ptr;
	}
