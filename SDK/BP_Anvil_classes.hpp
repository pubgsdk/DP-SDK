...
class ABP_Anvil_C : public ABP_MasterCraftingBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Anvil.BP_Anvil_C"));
		return ptr;
	}
