...
#include "BP_WoodSpikes_structs.hpp"
...
// BlueprintGeneratedClass BP_WoodSpikes.BP_WoodSpikes_C
// 0x0030 (0x0308 - 0x02D8)
class ABP_WoodSpikes_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodSpikes.BP_WoodSpikes_C"));
		return ptr;
	}
