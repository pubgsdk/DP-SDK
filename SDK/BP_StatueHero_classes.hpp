...
#include "BP_StatueHero_structs.hpp"
...
// BlueprintGeneratedClass BP_StatueHero.BP_StatueHero_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_StatueHero_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StatueHero.BP_StatueHero_C"));
		return ptr;
	}
