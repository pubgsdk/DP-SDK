...
#include "BP_ComputerMouseRed_structs.hpp"
...
// BlueprintGeneratedClass BP_ComputerMouseRed.BP_ComputerMouseRed_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ComputerMouseRed_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ComputerMouseRed.BP_ComputerMouseRed_C"));
		return ptr;
	}
