...
// BlueprintGeneratedClass BP_ToyOrc.BP_ToyOrc_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyOrc_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyOrc.BP_ToyOrc_C"));
		return ptr;
	}
