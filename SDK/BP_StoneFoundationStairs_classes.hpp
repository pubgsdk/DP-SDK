...
#include "BP_StoneFoundationStairs_structs.hpp"
...
class ABP_StoneFoundationStairs_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StoneFoundationStairs.BP_StoneFoundationStairs_C"));
		return ptr;
	}
