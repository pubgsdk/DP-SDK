...
#include "BP_SignNeonDino_structs.hpp"
...
// BlueprintGeneratedClass BP_SignNeonDino.BP_SignNeonDino_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignNeonDino_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignNeonDino.BP_SignNeonDino_C"));
		return ptr;
	}
