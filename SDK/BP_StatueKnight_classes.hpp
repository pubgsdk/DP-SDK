...
#include "BP_StatueKnight_structs.hpp"
...
// BlueprintGeneratedClass BP_StatueKnight.BP_StatueKnight_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_StatueKnight_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StatueKnight.BP_StatueKnight_C"));
		return ptr;
	}
