...
#include "BP_Flamingo_structs.hpp"
...
// BlueprintGeneratedClass BP_Flamingo.BP_Flamingo_C
// 0x0020 (0x02F8 - 0x02D8)
class ABP_Flamingo_C : public ABP_MasterDecoPart_C
{
public:
	...
	class UBoxComponent*                               BuildCollision1;                                          // 0x02F0(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Flamingo.BP_Flamingo_C"));
		return ptr;
	}
