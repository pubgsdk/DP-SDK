...
#include "BTT_FindActionPoint_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BTT_FindActionPoint.BTT_FindActionPoint_C"));
		return ptr;
	}


	void ReceiveExecute(class AActor* OwnerActor);
	void ExecuteUbergraph_BTT_FindActionPoint(int EntryPoint);
};
