...
#include "BP_FlashlightMaglite_structs.hpp"
...
// BlueprintGeneratedClass BP_FlashlightMaglite.BP_FlashlightMaglite_C
// 0x0020 (0x0458 - 0x0438)
class ABP_FlashlightMaglite_C : public ABP_MasterHoldable_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FlashlightMaglite.BP_FlashlightMaglite_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_FlashlightMaglite(int EntryPoint);
};
