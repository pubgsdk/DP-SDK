...
#include "BP_BaseDoor_structs.hpp"
...
// BlueprintGeneratedClass BP_BaseDoor.BP_BaseDoor_C
// 0x0078 (0x0350 - 0x02D8)
class ABP_BaseDoor_C : public ABP_MasterBuildPart_C
{
public:
	...
	float                                              Swing_Closed_Rotation_07DC7F3F4A91FEC11710BB8C27ED9FFB;   // 0x0300(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Swing_Closed__Direction_07DC7F3F4A91FEC11710BB8C27ED9FFB; // 0x0304(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	float                                              Swing_Open_Rotation_5F31DB924116A19A02F1849E6EA98846;     // 0x0310(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Swing_Open__Direction_5F31DB924116A19A02F1849E6EA98846;   // 0x0314(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_BaseDoor.BP_BaseDoor_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BaseDoor(int EntryPoint);
};
