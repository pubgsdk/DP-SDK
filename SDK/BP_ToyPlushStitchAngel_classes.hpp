...
#include "BP_ToyPlushStitchAngel_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushStitchAngel.BP_ToyPlushStitchAngel_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushStitchAngel_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushStitchAngel.BP_ToyPlushStitchAngel_C"));
		return ptr;
	}
