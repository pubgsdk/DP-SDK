...
#include "BP_Console3_structs.hpp"
...
// BlueprintGeneratedClass BP_Console3.BP_Console3_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_Console3_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Console3.BP_Console3_C"));
		return ptr;
	}
