...
#include "BP_PlushUnicornRare_structs.hpp"
...
// BlueprintGeneratedClass BP_PlushUnicornRare.BP_PlushUnicornRare_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_PlushUnicornRare_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PlushUnicornRare.BP_PlushUnicornRare_C"));
		return ptr;
	}
