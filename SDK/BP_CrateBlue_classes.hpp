...
#include "BP_CrateBlue_structs.hpp"
...
// BlueprintGeneratedClass BP_CrateBlue.BP_CrateBlue_C
// 0x0030 (0x0318 - 0x02E8)
class ABP_CrateBlue_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CrateBlue.BP_CrateBlue_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CrateBlue(int EntryPoint);
};
