...
#include "BP_ToyPlushDeadSquirrel_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushDeadSquirrel.BP_ToyPlushDeadSquirrel_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushDeadSquirrel_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushDeadSquirrel.BP_ToyPlushDeadSquirrel_C"));
		return ptr;
	}
