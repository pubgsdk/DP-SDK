...
// Function BP_Toolbox.BP_Toolbox_C.SGK EndInteraction
...
bool ABP_Toolbox_C::SGK_EndInteraction(class UBP_PlayerInventory_C* PlayerInventory)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Toolbox.BP_Toolbox_C.SGK EndInteraction"));
...
// Function BP_Toolbox.BP_Toolbox_C.SGK TurnedOnEffect
...
void ABP_Toolbox_C::SGK_TurnedOnEffect(bool TurnedOn)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Toolbox.BP_Toolbox_C.SGK TurnedOnEffect"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Toolbox.BP_Toolbox_C.ExecuteUbergraph_BP_Toolbox"));
