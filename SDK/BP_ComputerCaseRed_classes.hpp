...
#include "BP_ComputerCaseRed_structs.hpp"
...
// BlueprintGeneratedClass BP_ComputerCaseRed.BP_ComputerCaseRed_C
// 0x0020 (0x0308 - 0x02E8)
class ABP_ComputerCaseRed_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ComputerCaseRed.BP_ComputerCaseRed_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ComputerCaseRed(int EntryPoint);
};
