...
#include "BP_ToyPlushShark_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushShark.BP_ToyPlushShark_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushShark_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushShark.BP_ToyPlushShark_C"));
		return ptr;
	}
