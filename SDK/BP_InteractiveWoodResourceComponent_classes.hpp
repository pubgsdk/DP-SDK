...
#include "BP_InteractiveWoodResourceComponent_structs.hpp"
...
// BlueprintGeneratedClass BP_InteractiveWoodResourceComponent.BP_InteractiveWoodResourceComponent_C
// 0x000F (0x06B8 - 0x06A9)
class UBP_InteractiveWoodResourceComponent_C : public UBP_MasterResourceComponent_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_InteractiveWoodResourceComponent.BP_InteractiveWoodResourceComponent_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_InteractiveWoodResourceComponent(int EntryPoint);
};
