...
#include "BP_ToyMeeseeksBox_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyMeeseeksBox.BP_ToyMeeseeksBox_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyMeeseeksBox_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyMeeseeksBox.BP_ToyMeeseeksBox_C"));
		return ptr;
	}
