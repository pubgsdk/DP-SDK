...
#include "BP_FlowerPot4_structs.hpp"
...
// BlueprintGeneratedClass BP_FlowerPot4.BP_FlowerPot4_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_FlowerPot4_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FlowerPot4.BP_FlowerPot4_C"));
		return ptr;
	}
