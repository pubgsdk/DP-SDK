...
#include "BP_ToyCrewmateP_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCrewmateP.BP_ToyCrewmateP_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ToyCrewmateP_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCrewmateP.BP_ToyCrewmateP_C"));
		return ptr;
	}
