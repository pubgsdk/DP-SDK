...
public:
	...
	struct FMulticastScriptDelegate                    OnActorFracture;                                          // 0x0228(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPublic)
...
public:
	...
	struct FMulticastScriptDelegate                    OnComponentFracture;                                      // 0x06C0(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData03[0xA0];                                      // 0x06D0(0x00A0) MISSED OFFSET
