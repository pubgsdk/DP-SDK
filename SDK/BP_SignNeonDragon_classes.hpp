...
#include "BP_SignNeonDragon_structs.hpp"
...
// BlueprintGeneratedClass BP_SignNeonDragon.BP_SignNeonDragon_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignNeonDragon_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignNeonDragon.BP_SignNeonDragon_C"));
		return ptr;
	}
