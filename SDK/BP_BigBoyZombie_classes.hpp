...
#include "BP_BigBoyZombie_structs.hpp"
...
// BlueprintGeneratedClass BP_BigBoyZombie.BP_BigBoyZombie_C
// 0x000B (0x05E8 - 0x05DD)
class ABP_BigBoyZombie_C : public ABP_MasterAICharacter_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_BigBoyZombie.BP_BigBoyZombie_C"));
		return ptr;
	}
