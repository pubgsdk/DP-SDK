...
#include "BP_WoodShortWall_structs.hpp"
...
class ABP_WoodShortWall_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodShortWall.BP_WoodShortWall_C"));
		return ptr;
	}
