...
#include "BP_ToyDino1_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyDino1.BP_ToyDino1_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyDino1_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyDino1.BP_ToyDino1_C"));
		return ptr;
	}
