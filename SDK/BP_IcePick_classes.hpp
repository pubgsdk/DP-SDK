...
#include "BP_IcePick_structs.hpp"
...
// BlueprintGeneratedClass BP_IcePick.BP_IcePick_C
// 0x006C (0x0768 - 0x06FC)
class ABP_IcePick_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_IcePick.BP_IcePick_C"));
		return ptr;
	}
