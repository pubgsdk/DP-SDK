...
#include "BP_StoneWindowFrame_structs.hpp"
...
class ABP_StoneWindowFrame_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StoneWindowFrame.BP_StoneWindowFrame_C"));
		return ptr;
	}
