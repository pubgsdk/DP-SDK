...
#include "BP_PlushUnicorn_structs.hpp"
...
// BlueprintGeneratedClass BP_PlushUnicorn.BP_PlushUnicorn_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_PlushUnicorn_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PlushUnicorn.BP_PlushUnicorn_C"));
		return ptr;
	}
