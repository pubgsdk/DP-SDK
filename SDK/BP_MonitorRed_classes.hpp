...
#include "BP_MonitorRed_structs.hpp"
...
// BlueprintGeneratedClass BP_MonitorRed.BP_MonitorRed_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_MonitorRed_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MonitorRed.BP_MonitorRed_C"));
		return ptr;
	}
