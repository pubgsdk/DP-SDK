...
#include "BP_FlamingoAlt_structs.hpp"
...
// BlueprintGeneratedClass BP_FlamingoAlt.BP_FlamingoAlt_C
// 0x0020 (0x02F8 - 0x02D8)
class ABP_FlamingoAlt_C : public ABP_MasterDecoPart_C
{
public:
	class UBP_GroundCheckComponent_C*                  BP_GroundCheckComponent;                                  // 0x02D8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FlamingoAlt.BP_FlamingoAlt_C"));
		return ptr;
	}
