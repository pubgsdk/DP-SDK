...
#include "Notify_EmoteProp_classes.hpp"
...
// Function Notify_EmoteProp.Notify_EmoteProp_C.Received_Notify
...
bool UNotify_EmoteProp_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Notify_EmoteProp.Notify_EmoteProp_C.Received_Notify"));
