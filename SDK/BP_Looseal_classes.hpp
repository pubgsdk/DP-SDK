...
#include "BP_Looseal_structs.hpp"
...
// BlueprintGeneratedClass BP_Looseal.BP_Looseal_C
// 0x006C (0x0768 - 0x06FC)
class ABP_Looseal_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Looseal.BP_Looseal_C"));
		return ptr;
	}
