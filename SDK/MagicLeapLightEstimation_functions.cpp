...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.IsTrackerValid"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.GetColorTemperatureState"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.GetAmbientGlobalState"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.DestroyTracker"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapLightEstimation.MagicLeapLightEstimationFunctionLibrary.CreateTracker"));
