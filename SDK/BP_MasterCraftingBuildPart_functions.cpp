...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SGK EndInteraction"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SGK PossibleActions"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SGK AllowInteraction"));
...
bool ABP_MasterCraftingBuildPart_C::SGK_Interact(class UBP_PlayerInventory_C* PlayerInventory, TEnumAsByte<E_WorldActions> Action)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SGK Interact"));
...
void ABP_MasterCraftingBuildPart_C::SaveExtraData(class UBP_SGKSaveGame_C* SaveGame, const struct FS_LevelSaveData& LevelSaveData, int* ExtraDataIndex, struct FS_LevelSaveData* NewLevelSaveData)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SaveExtraData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SGK PlayerInProximity"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SGK PlayerOutProximity"));
...
void ABP_MasterCraftingBuildPart_C::SGK_LoadExtraData(class UBP_SGKSaveGame_C* SaveGame, int Index)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.SGK LoadExtraData"));
...
void ABP_MasterCraftingBuildPart_C::ExecuteUbergraph_BP_MasterCraftingBuildPart(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterCraftingBuildPart.BP_MasterCraftingBuildPart_C.ExecuteUbergraph_BP_MasterCraftingBuildPart"));
