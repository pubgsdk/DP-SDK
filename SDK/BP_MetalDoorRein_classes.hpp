...
#include "BP_MetalDoorRein_structs.hpp"
...
// BlueprintGeneratedClass BP_MetalDoorRein.BP_MetalDoorRein_C
// 0x0078 (0x0350 - 0x02D8)
class ABP_MetalDoorRein_C : public ABP_MasterBuildPart_C
{
public:
	...
	float                                              Swing_Closed_Rotation_FDF479E8430013716D7677BA96A5ACEF;   // 0x0300(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Swing_Closed__Direction_FDF479E8430013716D7677BA96A5ACEF; // 0x0304(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	float                                              Swing_Open_Rotation_45224D034CDF44BB94CA07AAFA8435C3;     // 0x0310(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Swing_Open__Direction_45224D034CDF44BB94CA07AAFA8435C3;   // 0x0314(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MetalDoorRein.BP_MetalDoorRein_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MetalDoorRein(int EntryPoint);
};
