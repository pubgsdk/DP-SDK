...
#include "BP_MedicalCrate_structs.hpp"
...
// BlueprintGeneratedClass BP_MedicalCrate.BP_MedicalCrate_C
// 0x0020 (0x0308 - 0x02E8)
class ABP_MedicalCrate_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	class UBP_GroundCheckComponent_C*                  BP_GroundCheckComponent2;                                 // 0x02F8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MedicalCrate.BP_MedicalCrate_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MedicalCrate(int EntryPoint);
};
