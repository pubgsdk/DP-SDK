...
#include "BP_ToyDino2_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyDino2.BP_ToyDino2_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyDino2_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyDino2.BP_ToyDino2_C"));
		return ptr;
	}
