...
#include "BP_WoodChest_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodChest.BP_WoodChest_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WoodChest(int EntryPoint);
};
