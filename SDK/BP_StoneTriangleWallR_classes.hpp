...
#include "BP_StoneTriangleWallR_structs.hpp"
...
class ABP_StoneTriangleWallR_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StoneTriangleWallR.BP_StoneTriangleWallR_C"));
		return ptr;
	}
