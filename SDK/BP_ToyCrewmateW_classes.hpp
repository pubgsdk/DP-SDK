...
#include "BP_ToyCrewmateW_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCrewmateW.BP_ToyCrewmateW_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ToyCrewmateW_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCrewmateW.BP_ToyCrewmateW_C"));
		return ptr;
	}
