...
#include "BP_MasterCookingBuildPart_structs.hpp"
...
public:
	...
	class UBP_CookingComponent_C*                      BP_CookingComponent;                                      // 0x02E0(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MasterCookingBuildPart.BP_MasterCookingBuildPart_C"));
		return ptr;
	}


	void LoadExtraCookingData(class UBP_SGKSaveGame_C* Save, int Index);
	...
	void ExecuteUbergraph_BP_MasterCookingBuildPart(int EntryPoint);
};
