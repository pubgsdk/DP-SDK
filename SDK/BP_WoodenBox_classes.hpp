...
#include "BP_WoodenBox_structs.hpp"
...
// BlueprintGeneratedClass BP_WoodenBox.BP_WoodenBox_C
// 0x0018 (0x0300 - 0x02E8)
class ABP_WoodenBox_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodenBox.BP_WoodenBox_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WoodenBox(int EntryPoint);
};
