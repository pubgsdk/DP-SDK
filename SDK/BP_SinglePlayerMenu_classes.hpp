...
#include "BP_SinglePlayerMenu_structs.hpp"
...
public:
	...
	class UBP_MenuButton_C*                            BP_WidgetToggleButton_3;                                  // 0x0308(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	class UBP_MenuButton_C*                            BP_WidgetToggleButton_150;                                // 0x0310(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	...
	struct FText                                       SubtitleText;                                             // 0x0330(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FText                                       TitleText;                                                // 0x0348(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateFontInfo                              SubtitleFont;                                             // 0x0360(0x0058) (CPF_Edit, CPF_BlueprintVisible, CPF_HasGetValueTypeHash)
	struct FSlateFontInfo                              TitleFont;                                                // 0x03B8(0x0058) (CPF_Edit, CPF_BlueprintVisible, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass BP_SinglePlayerMenu.BP_SinglePlayerMenu_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_SinglePlayerMenu(int EntryPoint);
};
