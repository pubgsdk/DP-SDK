...
#include "BP_ToyAfromatic_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyAfromatic.BP_ToyAfromatic_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyAfromatic_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyAfromatic.BP_ToyAfromatic_C"));
		return ptr;
	}
