...
#include "BP_ToyCrewmateDead_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCrewmateDead.BP_ToyCrewmateDead_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ToyCrewmateDead_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCrewmateDead.BP_ToyCrewmateDead_C"));
		return ptr;
	}
