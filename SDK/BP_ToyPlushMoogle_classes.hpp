...
#include "BP_ToyPlushMoogle_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushMoogle.BP_ToyPlushMoogle_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushMoogle_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushMoogle.BP_ToyPlushMoogle_C"));
		return ptr;
	}
