...
#include "BP_ToyParrot_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyParrot.BP_ToyParrot_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyParrot_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyParrot.BP_ToyParrot_C"));
		return ptr;
	}
