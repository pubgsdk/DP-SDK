...
#include "BP_WallLight1_structs.hpp"
...
// BlueprintGeneratedClass BP_WallLight1.BP_WallLight1_C
// 0x0021 (0x02F9 - 0x02D8)
class ABP_WallLight1_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WallLight1.BP_WallLight1_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WallLight1(int EntryPoint);
};
