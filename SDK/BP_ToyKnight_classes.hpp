...
#include "BP_ToyKnight_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyKnight.BP_ToyKnight_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyKnight_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyKnight.BP_ToyKnight_C"));
		return ptr;
	}
