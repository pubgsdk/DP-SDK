...
#include "BTT_EndFlee_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BTT_EndFlee.BTT_EndFlee_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BTT_EndFlee(int EntryPoint);
};
