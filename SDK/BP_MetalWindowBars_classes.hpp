...
#include "BP_MetalWindowBars_structs.hpp"
...
class ABP_MetalWindowBars_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MetalWindowBars.BP_MetalWindowBars_C"));
		return ptr;
	}
