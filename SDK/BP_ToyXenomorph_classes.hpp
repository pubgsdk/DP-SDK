...
#include "BP_ToyXenomorph_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyXenomorph.BP_ToyXenomorph_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyXenomorph_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyXenomorph.BP_ToyXenomorph_C"));
		return ptr;
	}
