...
#include "BP_MetalTriangleWallR_structs.hpp"
...
class ABP_MetalTriangleWallR_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MetalTriangleWallR.BP_MetalTriangleWallR_C"));
		return ptr;
	}
