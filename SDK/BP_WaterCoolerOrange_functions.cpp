...
#include "BP_WaterCoolerOrange_classes.hpp"
...
// Function BP_WaterCoolerOrange.BP_WaterCoolerOrange_C.SGK PossibleActions
...
void ABP_WaterCoolerOrange_C::SGK_PossibleActions(class UBP_PlayerInventory_C* PlayerInventory, bool* ActionsFound, TArray<struct FS_WorldAction>* PossibleActions)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_WaterCoolerOrange.BP_WaterCoolerOrange_C.SGK PossibleActions"));
...
// Function BP_WaterCoolerOrange.BP_WaterCoolerOrange_C.SGK Interact
// (FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// class UBP_PlayerInventory_C*   PlayerInventory                (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
bool ABP_WaterCoolerOrange_C::SGK_Interact(class UBP_PlayerInventory_C* PlayerInventory, TEnumAsByte<E_WorldActions> Action)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_WaterCoolerOrange.BP_WaterCoolerOrange_C.SGK Interact"));
