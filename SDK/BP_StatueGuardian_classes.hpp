...
#include "BP_StatueGuardian_structs.hpp"
...
// BlueprintGeneratedClass BP_StatueGuardian.BP_StatueGuardian_C
// 0x0028 (0x0300 - 0x02D8)
class ABP_StatueGuardian_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StatueGuardian.BP_StatueGuardian_C"));
		return ptr;
	}
