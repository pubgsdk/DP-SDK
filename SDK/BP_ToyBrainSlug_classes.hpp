...
#include "BP_ToyBrainSlug_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyBrainSlug.BP_ToyBrainSlug_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyBrainSlug_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyBrainSlug.BP_ToyBrainSlug_C"));
		return ptr;
	}
