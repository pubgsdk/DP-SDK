...
#include "BP_CouchRedChairTrashed_structs.hpp"
...
// BlueprintGeneratedClass BP_CouchRedChairTrashed.BP_CouchRedChairTrashed_C
// 0x0030 (0x0308 - 0x02D8)
class ABP_CouchRedChairTrashed_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CouchRedChairTrashed.BP_CouchRedChairTrashed_C"));
		return ptr;
	}
