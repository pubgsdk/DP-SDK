...
#include "BP_ToyPlushSkelemi_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushSkelemi.BP_ToyPlushSkelemi_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushSkelemi_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushSkelemi.BP_ToyPlushSkelemi_C"));
		return ptr;
	}
