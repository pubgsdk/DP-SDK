...
#include "BP_LampSpooky_structs.hpp"
...
// BlueprintGeneratedClass BP_LampSpooky.BP_LampSpooky_C
// 0x0021 (0x02F9 - 0x02D8)
class ABP_LampSpooky_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_LampSpooky.BP_LampSpooky_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_LampSpooky(int EntryPoint);
};
