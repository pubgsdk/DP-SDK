...
#include "BP_SkeletalMasterItem_structs.hpp"
...
public:
	...
	class ABP_SaveSystem_C*                            SaveGame;                                                 // 0x0280(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnTemplate, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	struct FS_InvItem                                  TempItem;                                                 // 0x0288(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_ContainsInstancedReference, CPF_HasGetValueTypeHash)
	TArray<class AActor*>                              Attachments;                                              // 0x02B8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnTemplate, CPF_DisableEditOnInstance)
	bool                                               UseDroppedItemDestroyTimer;                               // 0x02C8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)
	unsigned char                                      UnknownData02[0x3];                                       // 0x02C9(0x0003) MISSED OFFSET
	float                                              DropDestroyTime;                                          // 0x02CC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SkeletalMasterItem.BP_SkeletalMasterItem_C"));
		return ptr;
	}
	...
	void ItemDecay();
	void SpawnAttachments(const struct FS_InvItem& InvItem);
	void ItemOffsets();
	...
	void ExecuteUbergraph_BP_SkeletalMasterItem(int EntryPoint);
};
