...
#include "BP_ToyPlushElephant_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushElephant.BP_ToyPlushElephant_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushElephant_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushElephant.BP_ToyPlushElephant_C"));
		return ptr;
	}
