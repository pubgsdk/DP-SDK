...
#include "BP_NoDamageZone_structs.hpp"
...
{
public:
	class UBoxComponent*                               NoDamageZone;                                             // 0x0220(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_NoDamageZone.BP_NoDamageZone_C"));
		return ptr;
	}
