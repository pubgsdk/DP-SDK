...
#include "BP_Furnace_structs.hpp"
...
public:
	...
	class UBoxComponent*                               Box;                                                      // 0x0300(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Furnace.BP_Furnace_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Furnace(int EntryPoint);
};
