...
#include "BP_WoodDresser_structs.hpp"
...
// BlueprintGeneratedClass BP_WoodDresser.BP_WoodDresser_C
// 0x0018 (0x0300 - 0x02E8)
class ABP_WoodDresser_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodDresser.BP_WoodDresser_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WoodDresser(int EntryPoint);
};
