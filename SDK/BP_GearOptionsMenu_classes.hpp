...
#include "BP_GearOptionsMenu_structs.hpp"
...
public:
	...
	struct FS_EquipmentSlot                            SelectedEquipmentSlot;                                    // 0x0290(0x0048) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_ContainsInstancedReference, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass BP_GearOptionsMenu.BP_GearOptionsMenu_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_GearOptionsMenu(int EntryPoint);
};
