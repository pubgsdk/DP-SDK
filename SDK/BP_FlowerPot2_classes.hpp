...
#include "BP_FlowerPot2_structs.hpp"
...
// BlueprintGeneratedClass BP_FlowerPot2.BP_FlowerPot2_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_FlowerPot2_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FlowerPot2.BP_FlowerPot2_C"));
		return ptr;
	}
