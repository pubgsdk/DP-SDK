...
#include "BP_GramophoneBroken_structs.hpp"
...
// BlueprintGeneratedClass BP_GramophoneBroken.BP_GramophoneBroken_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_GramophoneBroken_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_GramophoneBroken.BP_GramophoneBroken_C"));
		return ptr;
	}
