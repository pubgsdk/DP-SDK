...
#include "BP_CrateGreen_structs.hpp"
...
// BlueprintGeneratedClass BP_CrateGreen.BP_CrateGreen_C
// 0x0030 (0x0318 - 0x02E8)
class ABP_CrateGreen_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CrateGreen.BP_CrateGreen_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CrateGreen(int EntryPoint);
};
