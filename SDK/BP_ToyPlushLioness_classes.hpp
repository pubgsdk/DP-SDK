...
#include "BP_ToyPlushLioness_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushLioness.BP_ToyPlushLioness_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushLioness_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushLioness.BP_ToyPlushLioness_C"));
		return ptr;
	}
