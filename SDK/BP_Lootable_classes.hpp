...
#include "BP_Lootable_structs.hpp"
...
// BlueprintGeneratedClass BP_Lootable.BP_Lootable_C
// 0x0020 (0x0308 - 0x02E8)
class ABP_Lootable_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Lootable.BP_Lootable_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Lootable(int EntryPoint);
};
