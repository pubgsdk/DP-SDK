...
#include "BP_ToyJoker_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyJoker.BP_ToyJoker_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyJoker_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyJoker.BP_ToyJoker_C"));
		return ptr;
	}
