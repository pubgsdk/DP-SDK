...
#include "BP_Dumpster_L_structs.hpp"
...
// BlueprintGeneratedClass BP_Dumpster_L.BP_Dumpster_L_C
// 0x0020 (0x0308 - 0x02E8)
class ABP_Dumpster_L_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Dumpster_L.BP_Dumpster_L_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Dumpster_L(int EntryPoint);
};
