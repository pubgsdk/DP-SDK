...
#include "BP_Target1_structs.hpp"
...
class ABP_Target1_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Target1.BP_Target1_C"));
		return ptr;
	}
