...
#include "BP_Present_A_structs.hpp"
...
// BlueprintGeneratedClass BP_Present_A.BP_Present_A_C
// 0x0018 (0x0300 - 0x02E8)
class ABP_Present_A_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Present_A.BP_Present_A_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Present_A(int EntryPoint);
};
