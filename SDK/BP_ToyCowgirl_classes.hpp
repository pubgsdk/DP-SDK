...
#include "BP_ToyCowgirl_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCowgirl.BP_ToyCowgirl_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyCowgirl_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCowgirl.BP_ToyCowgirl_C"));
		return ptr;
	}
