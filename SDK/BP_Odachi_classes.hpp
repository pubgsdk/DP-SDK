...
// BlueprintGeneratedClass BP_Odachi.BP_Odachi_C
// 0x006C (0x0768 - 0x06FC)
class ABP_Odachi_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Odachi.BP_Odachi_C"));
		return ptr;
	}
