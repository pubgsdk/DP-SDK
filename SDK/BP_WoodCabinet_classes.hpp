...
#include "BP_WoodCabinet_structs.hpp"
...
// BlueprintGeneratedClass BP_WoodCabinet.BP_WoodCabinet_C
// 0x0020 (0x0308 - 0x02E8)
class ABP_WoodCabinet_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodCabinet.BP_WoodCabinet_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_WoodCabinet(int EntryPoint);
};
