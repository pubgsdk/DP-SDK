...
#include "BP_SkullBlake_structs.hpp"
...
// BlueprintGeneratedClass BP_SkullBlake.BP_SkullBlake_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SkullBlake_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SkullBlake.BP_SkullBlake_C"));
		return ptr;
	}
