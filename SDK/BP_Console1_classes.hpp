...
#include "BP_Console1_structs.hpp"
...
// BlueprintGeneratedClass BP_Console1.BP_Console1_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_Console1_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Console1.BP_Console1_C"));
		return ptr;
	}
