...
#include "BP_ToyPlushPoro_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushPoro.BP_ToyPlushPoro_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushPoro_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushPoro.BP_ToyPlushPoro_C"));
		return ptr;
	}
