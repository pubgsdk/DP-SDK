...
#include "BP_ToyPlushMurlocBaby_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushMurlocBaby.BP_ToyPlushMurlocBaby_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushMurlocBaby_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushMurlocBaby.BP_ToyPlushMurlocBaby_C"));
		return ptr;
	}
