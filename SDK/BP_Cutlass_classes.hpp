...
#include "BP_Cutlass_structs.hpp"
...
// BlueprintGeneratedClass BP_Cutlass.BP_Cutlass_C
// 0x006C (0x0768 - 0x06FC)
class ABP_Cutlass_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	class UBP_MeleeTraceSocket_C*                      MeleeTraceSocket_01;                                      // 0x0760(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Cutlass.BP_Cutlass_C"));
		return ptr;
	}
