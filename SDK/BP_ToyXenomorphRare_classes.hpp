...
#include "BP_ToyXenomorphRare_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyXenomorphRare.BP_ToyXenomorphRare_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyXenomorphRare_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyXenomorphRare.BP_ToyXenomorphRare_C"));
		return ptr;
	}
