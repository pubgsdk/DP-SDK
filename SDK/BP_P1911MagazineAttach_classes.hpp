...
#include "BP_P1911MagazineAttach_structs.hpp"
...
class ABP_P1911MagazineAttach_C : public ABP_MasterAttachment_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_P1911MagazineAttach.BP_P1911MagazineAttach_C"));
		return ptr;
	}
