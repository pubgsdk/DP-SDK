...
#include "BP_ToyDumpTruck_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyDumpTruck.BP_ToyDumpTruck_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyDumpTruck_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyDumpTruck.BP_ToyDumpTruck_C"));
		return ptr;
	}
