...
#include "BP_CouchRedTrashed_structs.hpp"
...
// BlueprintGeneratedClass BP_CouchRedTrashed.BP_CouchRedTrashed_C
// 0x0030 (0x0308 - 0x02D8)
class ABP_CouchRedTrashed_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CouchRedTrashed.BP_CouchRedTrashed_C"));
		return ptr;
	}
