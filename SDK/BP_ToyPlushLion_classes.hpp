...
#include "BP_ToyPlushLion_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPlushLion.BP_ToyPlushLion_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPlushLion_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPlushLion.BP_ToyPlushLion_C"));
		return ptr;
	}
