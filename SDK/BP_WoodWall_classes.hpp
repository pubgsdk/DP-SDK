...
#include "BP_WoodWall_structs.hpp"
...
class ABP_WoodWall_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodWall.BP_WoodWall_C"));
		return ptr;
	}
