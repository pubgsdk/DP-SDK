...
#include "BP_NailMag_structs.hpp"
...
// BlueprintGeneratedClass BP_NailMag.BP_NailMag_C
// 0x000C (0x02F8 - 0x02EC)
class ABP_NailMag_C : public ABP_MasterAttachment_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_NailMag.BP_NailMag_C"));
		return ptr;
	}
