...
#include "BP_ComputerKeyboardRed_structs.hpp"
...
// BlueprintGeneratedClass BP_ComputerKeyboardRed.BP_ComputerKeyboardRed_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ComputerKeyboardRed_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ComputerKeyboardRed.BP_ComputerKeyboardRed_C"));
		return ptr;
	}
