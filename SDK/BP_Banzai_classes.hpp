...
// BlueprintGeneratedClass BP_Banzai.BP_Banzai_C
// 0x0028 (0x0300 - 0x02D8)
class ABP_Banzai_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Banzai.BP_Banzai_C"));
		return ptr;
	}
