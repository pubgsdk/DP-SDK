...
#include "BP_AmmoBox_structs.hpp"
...
class ABP_AmmoBox_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_AmmoBox.BP_AmmoBox_C"));
		return ptr;
	}
