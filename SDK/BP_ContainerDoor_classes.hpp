...
#include "BP_ContainerDoor_structs.hpp"
...
// BlueprintGeneratedClass BP_ContainerDoor.BP_ContainerDoor_C
// 0x0050 (0x0328 - 0x02D8)
class ABP_ContainerDoor_C : public ABP_MasterBuildPart_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x02D8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient)
	float                                              Swing_Closed_Rotation_B82C632F4B30EC58630F9A9DDDCB6E70;   // 0x02E0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Swing_Closed__Direction_B82C632F4B30EC58630F9A9DDDCB6E70; // 0x02E4(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	float                                              Swing_Open_Rotation_4E19DEBC4B6DCE3549B96CB81B0F8E01;     // 0x02F0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Swing_Open__Direction_4E19DEBC4B6DCE3549B96CB81B0F8E01;   // 0x02F4(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ContainerDoor.BP_ContainerDoor_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ContainerDoor(int EntryPoint);
};
