...
#include "BP_ToyRobot_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyRobot.BP_ToyRobot_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyRobot_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyRobot.BP_ToyRobot_C"));
		return ptr;
	}
