...
#include "BP_CouchPurpleChairTrashed_structs.hpp"
...
// BlueprintGeneratedClass BP_CouchPurpleChairTrashed.BP_CouchPurpleChairTrashed_C
// 0x0030 (0x0308 - 0x02D8)
class ABP_CouchPurpleChairTrashed_C : public ABP_MasterDecoPart_C
{
public:
	...
	class UBP_GroundCheckComponent_C*                  BP_GroundCheckComponent3;                                 // 0x02E8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CouchPurpleChairTrashed.BP_CouchPurpleChairTrashed_C"));
		return ptr;
	}
