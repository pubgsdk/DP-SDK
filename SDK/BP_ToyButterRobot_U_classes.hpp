...
#include "BP_ToyButterRobot_U_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyButterRobot_U.BP_ToyButterRobot_U_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyButterRobot_U_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyButterRobot_U.BP_ToyButterRobot_U_C"));
		return ptr;
	}
