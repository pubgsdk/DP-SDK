...
// BlueprintGeneratedClass BP_Plant1.BP_Plant1_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_Plant1_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Plant1.BP_Plant1_C"));
		return ptr;
	}
