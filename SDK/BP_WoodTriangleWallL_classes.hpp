...
#include "BP_WoodTriangleWallL_structs.hpp"
...
class ABP_WoodTriangleWallL_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WoodTriangleWallL.BP_WoodTriangleWallL_C"));
		return ptr;
	}
