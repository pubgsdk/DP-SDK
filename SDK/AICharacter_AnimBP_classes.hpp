...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass AICharacter_AnimBP.AICharacter_AnimBP_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_AICharacter_AnimBP(int EntryPoint);
};
