...
#include "BP_ToyTractorRare_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyTractorRare.BP_ToyTractorRare_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyTractorRare_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyTractorRare.BP_ToyTractorRare_C"));
		return ptr;
	}
