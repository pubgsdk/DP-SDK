...
#include "BP_GarbageBinMetal_structs.hpp"
...
// BlueprintGeneratedClass BP_GarbageBinMetal.BP_GarbageBinMetal_C
// 0x0018 (0x0300 - 0x02E8)
class ABP_GarbageBinMetal_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_GarbageBinMetal.BP_GarbageBinMetal_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_GarbageBinMetal(int EntryPoint);
};
