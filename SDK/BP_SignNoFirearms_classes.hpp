...
#include "BP_SignNoFirearms_structs.hpp"
...
// BlueprintGeneratedClass BP_SignNoFirearms.BP_SignNoFirearms_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignNoFirearms_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignNoFirearms.BP_SignNoFirearms_C"));
		return ptr;
	}
