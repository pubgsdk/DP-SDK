...
#include "BP_Boardwalk_structs.hpp"
...
// BlueprintGeneratedClass BP_Boardwalk.BP_Boardwalk_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_Boardwalk_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Boardwalk.BP_Boardwalk_C"));
		return ptr;
	}
