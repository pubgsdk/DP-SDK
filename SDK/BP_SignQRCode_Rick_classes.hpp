...
#include "BP_SignQRCode_Rick_structs.hpp"
...
// BlueprintGeneratedClass BP_SignQRCode_Rick.BP_SignQRCode_Rick_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignQRCode_Rick_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignQRCode_Rick.BP_SignQRCode_Rick_C"));
		return ptr;
	}
