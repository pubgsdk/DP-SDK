...
public:
	...
	struct FMulticastScriptDelegate                    OnSystemFinished;                                         // 0x0568(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData05[0x65];                                      // 0x058B(0x0065) MISSED OFFSET
...
public:
	...
	class UClass* /*ANiagaraPreviewBase*/              PreviewClass;                                             // 0x0240(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	...
	TArray<class UChildActorComponent*>                PreviewComponents;                                        // 0x0258(0x0010) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_ContainsInstancedReference, CPF_NativeAccessSpecifierPrivate)
