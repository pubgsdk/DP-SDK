...
#include "BP_ToyCrewmatePink_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCrewmatePink.BP_ToyCrewmatePink_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ToyCrewmatePink_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCrewmatePink.BP_ToyCrewmatePink_C"));
		return ptr;
	}
