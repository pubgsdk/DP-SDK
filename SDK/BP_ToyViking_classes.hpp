...
#include "BP_ToyViking_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyViking.BP_ToyViking_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyViking_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyViking.BP_ToyViking_C"));
		return ptr;
	}
