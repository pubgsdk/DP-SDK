...
#include "BP_Crowbar_structs.hpp"
...
class ABP_Crowbar_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	class UBP_MeleeTraceSocket_C*                      MeleeTraceSocket_02;                                      // 0x0730(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	class UStaticMeshComponent*                        StaticMesh;                                               // 0x0738(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Crowbar.BP_Crowbar_C"));
		return ptr;
	}
