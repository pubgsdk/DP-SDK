...
#include "BP_ToyCrewmateG_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyCrewmateG.BP_ToyCrewmateG_C
// 0x0018 (0x02F0 - 0x02D8)
class ABP_ToyCrewmateG_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyCrewmateG.BP_ToyCrewmateG_C"));
		return ptr;
	}
