...
// BlueprintGeneratedClass BP_Teddy.BP_Teddy_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_Teddy_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Teddy.BP_Teddy_C"));
		return ptr;
	}
