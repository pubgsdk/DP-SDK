...
#include "BP_StatueAngel_structs.hpp"
...
// BlueprintGeneratedClass BP_StatueAngel.BP_StatueAngel_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_StatueAngel_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StatueAngel.BP_StatueAngel_C"));
		return ptr;
	}
