...
#include "BP_MetalFoundationStairs_structs.hpp"
...
class ABP_MetalFoundationStairs_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MetalFoundationStairs.BP_MetalFoundationStairs_C"));
		return ptr;
	}
