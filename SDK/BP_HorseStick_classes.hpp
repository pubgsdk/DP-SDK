...
#include "BP_HorseStick_structs.hpp"
...
// BlueprintGeneratedClass BP_HorseStick.BP_HorseStick_C
// 0x006C (0x0768 - 0x06FC)
class ABP_HorseStick_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_HorseStick.BP_HorseStick_C"));
		return ptr;
	}
