...
#include "BP_ToyPeaShooter_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyPeaShooter.BP_ToyPeashooter_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyPeashooter_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyPeaShooter.BP_ToyPeashooter_C"));
		return ptr;
	}
