...
#include "BP_Baguette_structs.hpp"
...
// BlueprintGeneratedClass BP_Baguette.BP_Baguette_C
// 0x001C (0x0718 - 0x06FC)
class ABP_Baguette_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Baguette.BP_Baguette_C"));
		return ptr;
	}
