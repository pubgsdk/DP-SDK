...
// Function BP_MasterRespawnPoint.BP_MasterRespawnPoint_C.SGK InteractName
// (FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// struct FText                   InteractName                   (CPF_Parm, CPF_OutParm)

void ABP_MasterRespawnPoint_C::SGK_InteractName(struct FText* InteractName)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterRespawnPoint.BP_MasterRespawnPoint_C.SGK InteractName"));
...
bool ABP_MasterRespawnPoint_C::SGK_Interact(class UBP_PlayerInventory_C* PlayerInventory, TEnumAsByte<E_WorldActions> Action)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterRespawnPoint.BP_MasterRespawnPoint_C.SGK Interact"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterRespawnPoint.BP_MasterRespawnPoint_C.SGK AllowInteraction"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterRespawnPoint.BP_MasterRespawnPoint_C.SGK PossibleActions"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterRespawnPoint.BP_MasterRespawnPoint_C.ReceiveDestroyed"));
...
void ABP_MasterRespawnPoint_C::ExecuteUbergraph_BP_MasterRespawnPoint(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterRespawnPoint.BP_MasterRespawnPoint_C.ExecuteUbergraph_BP_MasterRespawnPoint"));
