...
#include "BP_ToyButterRobot_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyButterRobot.BP_ToyButterRobot_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyButterRobot_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyButterRobot.BP_ToyButterRobot_C"));
		return ptr;
	}
