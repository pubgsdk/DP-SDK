...
#include "BP_MoneyCase_structs.hpp"
...
// BlueprintGeneratedClass BP_MoneyCase.BP_MoneyCase_C
// 0x0020 (0x0308 - 0x02E8)
class ABP_MoneyCase_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MoneyCase.BP_MoneyCase_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MoneyCase(int EntryPoint);
};
