...
#include "BP_SignNeonPineapple_structs.hpp"
...
// BlueprintGeneratedClass BP_SignNeonPineapple.BP_SignNeonPineapple_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignNeonPineapple_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignNeonPineapple.BP_SignNeonPineapple_C"));
		return ptr;
	}
