...
#include "BP_MetalShortWall_structs.hpp"
...
class ABP_MetalShortWall_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MetalShortWall.BP_MetalShortWall_C"));
		return ptr;
	}
