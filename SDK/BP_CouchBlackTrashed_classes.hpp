...
#include "BP_CouchBlackTrashed_structs.hpp"
...
// BlueprintGeneratedClass BP_CouchBlackTrashed.BP_CouchBlackTrashed_C
// 0x0030 (0x0308 - 0x02D8)
class ABP_CouchBlackTrashed_C : public ABP_MasterDecoPart_C
{
public:
	class UBoxComponent*                               BuildCollision1;                                          // 0x02D8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	...
	class UBP_GroundCheckComponent_C*                  BP_GroundCheckComponent3;                                 // 0x02E8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CouchBlackTrashed.BP_CouchBlackTrashed_C"));
		return ptr;
	}
