...
#include "BP_CrateOrange_structs.hpp"
...
// BlueprintGeneratedClass BP_CrateOrange.BP_CrateOrange_C
// 0x0030 (0x0318 - 0x02E8)
class ABP_CrateOrange_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	class UBP_GroundCheckComponent_C*                  BP_GroundCheckComponent1;                                 // 0x0308(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CrateOrange.BP_CrateOrange_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CrateOrange(int EntryPoint);
};
