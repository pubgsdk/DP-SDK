...
#include "BP_WindowBarricade_structs.hpp"
...
// BlueprintGeneratedClass BP_WindowBarricade.BP_WindowBarricade_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_WindowBarricade_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WindowBarricade.BP_WindowBarricade_C"));
		return ptr;
	}
