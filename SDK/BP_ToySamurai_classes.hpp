...
#include "BP_ToySamurai_structs.hpp"
...
// BlueprintGeneratedClass BP_ToySamurai.BP_ToySamurai_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToySamurai_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToySamurai.BP_ToySamurai_C"));
		return ptr;
	}
