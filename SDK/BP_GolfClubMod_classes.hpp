...
#include "BP_GolfClubMod_structs.hpp"
...
// BlueprintGeneratedClass BP_GolfClubMod.BP_GolfClubMod_C
// 0x006C (0x0768 - 0x06FC)
class ABP_GolfClubMod_C : public ABP_MasterMeleeWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_GolfClubMod.BP_GolfClubMod_C"));
		return ptr;
	}
