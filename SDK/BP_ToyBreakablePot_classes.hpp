...
#include "BP_ToyBreakablePot_structs.hpp"
...
// BlueprintGeneratedClass BP_ToyBreakablePot.BP_ToyBreakablePot_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_ToyBreakablePot_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ToyBreakablePot.BP_ToyBreakablePot_C"));
		return ptr;
	}
