...
#include "BP_WindowBars_structs.hpp"
...
// BlueprintGeneratedClass BP_WindowBars.BP_WindowBars_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_WindowBars_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_WindowBars.BP_WindowBars_C"));
		return ptr;
	}
