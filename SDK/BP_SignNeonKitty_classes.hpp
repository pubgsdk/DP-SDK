...
#include "BP_SignNeonKitty_structs.hpp"
...
// BlueprintGeneratedClass BP_SignNeonKitty.BP_SignNeonKitty_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_SignNeonKitty_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SignNeonKitty.BP_SignNeonKitty_C"));
		return ptr;
	}
