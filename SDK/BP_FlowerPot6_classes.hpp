...
#include "BP_FlowerPot6_structs.hpp"
...
// BlueprintGeneratedClass BP_FlowerPot6.BP_FlowerPot6_C
// 0x0010 (0x02E8 - 0x02D8)
class ABP_FlowerPot6_C : public ABP_MasterDecoPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_FlowerPot6.BP_FlowerPot6_C"));
		return ptr;
	}
