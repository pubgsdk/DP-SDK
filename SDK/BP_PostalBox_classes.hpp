...
#include "BP_PostalBox_structs.hpp"
...
// BlueprintGeneratedClass BP_PostalBox.BP_PostalBox_C
// 0x0020 (0x0308 - 0x02E8)
class ABP_PostalBox_C : public ABP_MasterStorageBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PostalBox.BP_PostalBox_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PostalBox(int EntryPoint);
};
