...
#include "BP_BasicWindowBars_structs.hpp"
...
class ABP_BasicWindowBars_C : public ABP_MasterBuildPart_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_BasicWindowBars.BP_BasicWindowBars_C"));
		return ptr;
	}
