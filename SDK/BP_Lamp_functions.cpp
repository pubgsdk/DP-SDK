...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lamp.BP_Lamp_C.SGK PossibleActions"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lamp.BP_Lamp_C.SGK AllowInteraction"));
...
bool ABP_Lamp_C::SGK_Interact(class UBP_PlayerInventory_C* PlayerInventory, TEnumAsByte<E_WorldActions> Action)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lamp.BP_Lamp_C.SGK Interact"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lamp.BP_Lamp_C.MultcastToggleLight"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lamp.BP_Lamp_C.SGK BuildPartPlaced"));
...
void ABP_Lamp_C::ExecuteUbergraph_BP_Lamp(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lamp.BP_Lamp_C.ExecuteUbergraph_BP_Lamp"));
